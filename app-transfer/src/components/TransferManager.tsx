    ...
    return (
        ...
        <div className="mx-auto bg-white p-6 rounded-lg shadow-md">
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <button type="button" className="px-5 py-2.5 text-sm font-medium text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Aprobar 3</button>
