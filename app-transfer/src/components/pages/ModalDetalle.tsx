...
export const ModalDetalle = () => {
  ...
  const { transferencia, loadingTransferencia, errorMessageTransferencia } =
    useAppSelector((state) => state.transferencia);
  const {
    detalleTransferencia,
    loadingDeTransferencia,
    errorMessageDeTransferencia,
  } = useAppSelector((state) => state.detalleTransferencia);
